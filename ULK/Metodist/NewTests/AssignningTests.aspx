...
<asp:Content ID="contentAssignningTestPage" ContentPlaceHolderID="metodistContentPlaceHolder"
    ...
    <asp:UpdatePanel ID="assignningTestsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            <asp:Label ID="assinningTestLabel" CssClass="title" runat="server" Text="Назначение тестов"></asp:Label>
            <br />
            <br />
            <table width="100%">
                <tr>
                    <td>
                        <asp:Label ID="departmentLabel" runat="server" Text="Факультет" 
                    ...
                    <tr>
                        <td width="25%">
                            <asp:Label ID="disciplineLabel" runat="server" Text="Дисциплина" 
                                Font-Size="Medium"></asp:Label>
                            &nbsp;/
            ...
            <br />
            <asp:Button ID="saveCurrentTest" runat="server" Text="Принять" CssClass="button"
