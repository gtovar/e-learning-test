...
public partial class Admin_DisciplineParts_ManageDisciplineParts : System.Web.UI.Page
{
    ...
    protected void addDisciplinePart_Click(object sender, EventArgs e)
    {
        string url = UrlConstants.AddDisciplinePartUrl + "?DepartmentID=" + departmentsList.SelectedValue + "&ChairID=" + chairsList.SelectedValue + "&DisciplineID=" + disciplinesList.SelectedValue; ;
