<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AddDisciplinePart.aspx.cs" Inherits="Admin_DisciplineParts_AddDisciplinePart" %>

<asp:Content ID="headAddDisciplinePartPage" ContentPlaceHolderID="headAdminMasterPage" Runat="Server">
</asp:Content>
<asp:Content ID="contentAddDisciplinePartPage" ContentPlaceHolderID="adminContentPlaceHolder" Runat="Server">
    <asp:UpdatePanel ID="addDisciplinePartsUpdatePanel" runat="server">
        <ContentTemplate>
            <asp:Label ID="addDisciplinePartLabel" runat="server" 
                Text="Добавить раздел дисциплины" CssClass="title"></asp:Label>
            <br />
            <br />
