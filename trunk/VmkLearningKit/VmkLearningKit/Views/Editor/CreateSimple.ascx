...
<%@ Import Namespace="VmkLearningKit" %>
    <table class="Editor" style="width:100%;">
        ...
        <tr class="Editor">
            ...
            <td class="Editor" style="width:80%"><%= Html.Encode("простой") %></td>
        </tr>
        <tr class="Editor">
        ...
        <tr class="Editor">
            ...
            <td class="Editor" style="width:80%"><div style="width:100%"><%= Html.TextArea(VLKConstants.NEW_VARIANT_ANSWER_TEXT + "0", new { @class = "TextEditor", style = "width:inherit; height: 100px;" }) %></div></td>
        </tr>
        <tr class="Editor">
            <td class="Editor" style="width:20%"><label for="<%= VLKConstants.NEW_VARIANT_ANSWER_SCORE + "0"%>">Количество баллов:</label></td>
            <td class="Editor" style="width:80%"><div style="width:100%"><%= Html.TextBox(VLKConstants.NEW_VARIANT_ANSWER_SCORE + "0") %></div></td>
        </tr>
    </table>