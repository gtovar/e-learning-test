...
(function($) {
    ...
    jHtmlArea.defaultOptions = {
        toolbar: [
        "forecolor", "|", "bold", "italic", "underline", "strikethrough", "|", "subscript", "superscript", "|",
        ...
        toolbarText: {
            ...
            h1: "Заголовок 1", h2: "Заголовок 2", h3: "Заголовок 3", h4: "Заголовок 4", h5: "Заголовок 5", h6: "Заголовок 6", p: "Параграф",
            indent: "Увеличить отступ", outdent: "Уменьшить отступ", horizontalrule: "Вставить горизонтальную линию",
            justifyleft: "Выровнять по левому краю", justifycenter: "Выровнять по центру", justifyright: "Выровнять по правому краю",
            increasefontsize: "Увеличить размер шрифта", decreasefontsize: "Уменьшить размер шрифта", forecolor: "Цвет текста",
            link: "Вставить гиперссылку", unlink: "Удалить гиперссылку", image: "Вставить изображение",
            orderedlist: "Вставить нумерованный список", unorderedlist: "Вставить маркированный список",
            subscript: "Подстрочный", superscript: "Надстрочный",
            html: "Посмотреть/Скрыть html-разметку"
        }
    };
    var priv = {
        toolbarButtons: {
