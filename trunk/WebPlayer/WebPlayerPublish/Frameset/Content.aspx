<%@ page language="C#" autoeventwireup="true" inherits="Microsoft.LearningComponents.Frameset.Frameset_Content, App_Web_2vinkmfp" enableviewstate="false" enableviewstatemac="false" %>
...
<body class="ErrorBody" onload="OnLoad();">
    ...
    { %>
        <table border="0" width="100%" id="table1" style="border-collapse: collapse">
            <tr>
                <td width="60"><p align="center"><img border="0" src="<%= FramesetPath %>Theme/<%= ErrorIcon %>" width="49" height="49"></td>
                <td class="ErrorTitle"><%= ErrorTitleHtml %></td>
            </tr>
            <tr>
                <td width="61">&nbsp;</td>
                <td width="100%"><hr></td>
            ...
            <tr>
                <td width="61">&nbsp;</td>
                <td class="ErrorMessage"><%= ErrorMessageHtml %></td>
            </tr>
        </table>
    <% } %>
    </form>
