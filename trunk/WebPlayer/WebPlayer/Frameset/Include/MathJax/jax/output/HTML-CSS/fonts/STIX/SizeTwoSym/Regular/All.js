...
MathJax.Hub.Insert(
  MathJax.OutputJax['HTML-CSS'].FONTDATA.FONTS['STIXSizeTwoSym'],
  {
    ...
    0x305: [820,-770,0,0,1500],        // ̅
    0x30C: [777,-564,0,0,979],         // ̌
    0x330: [-117,269,0,-2,977],        // ̰
    0x332: [-127,177,0,0,1000],        // ̲
    0x338: [662,0,0,0,714],            // ̸
    0x20D0: [749,-584,0,27,1335],      // ⃐
    0x20D1: [749,-584,0,27,1335],      // ⃑
    0x20D6: [735,-482,0,27,1335],      // ⃖
    0x20D7: [735,-482,0,27,1335],      // ⃗
    0x20EC: [-123,288,0,27,1335],      // ⃬
    0x20ED: [-123,288,0,27,1335],      // ⃭
    0x20EE: [-26,279,0,27,1335],       // ⃮
    0x20EF: [-26,279,0,27,1335],       // ⃯
