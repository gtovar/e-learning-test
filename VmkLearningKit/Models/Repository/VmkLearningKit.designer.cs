...
namespace VmkLearningKit.Models.Repository
{
    ...
    partial void OnPartChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Time", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string Time
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Part", DbType="NVarChar(255)")]
		public string Part
		{
			get
			{
		...
		public SpecialityDiscipline SpecialityDiscipline
		{
			...
			set
			{
							...
							|| (this._SpecialityDiscipline.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._SpecialityDiscipline.Entity = null;
						previousValue.SpecialityDisciplineProgram = null;
					}
					this._SpecialityDiscipline.Entity = value;
					if ((value != null))
					{
						value.SpecialityDisciplineProgram = this;
						this._SpecialityDisciplineId = value.Id;
					}
					else
					{
	...
	public partial class SpecialityDiscipline : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<SpecialityDisciplineProgram> _SpecialityDisciplineProgram;
    ...
    partial void OnAbbreviationChanged();
		...
		public SpecialityDiscipline()
		{
			...
			this._PracticeAndLabTimetables = new EntitySet<PracticeAndLabTimetable>(new Action<PracticeAndLabTimetable>(this.attach_PracticeAndLabTimetables), new Action<PracticeAndLabTimetable>(this.detach_PracticeAndLabTimetables));
			this._PracticePlans = new EntitySet<PracticePlan>(new Action<PracticePlan>(this.attach_PracticePlans), new Action<PracticePlan>(this.detach_PracticePlans));
			this._SpecialityDisciplineProgram = default(EntityRef<SpecialityDisciplineProgram>);
			this._SpecialityDisciplinesProfessors = new EntitySet<SpecialityDisciplinesProfessor>(new Action<SpecialityDisciplinesProfessor>(this.attach_SpecialityDisciplinesProfessors), new Action<SpecialityDisciplinesProfessor>(this.detach_SpecialityDisciplinesProfessors));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SpecialityDiscipline_SpecialityDisciplineProgram", Storage="_SpecialityDisciplineProgram", ThisKey="Id", OtherKey="SpecialityDisciplineId", IsUnique=true, IsForeignKey=false)]
		public SpecialityDisciplineProgram SpecialityDisciplineProgram
		{
			get
			{
				return this._SpecialityDisciplineProgram.Entity;
			}
			set
			{
				SpecialityDisciplineProgram previousValue = this._SpecialityDisciplineProgram.Entity;
				if (((previousValue != value) 
							|| (this._SpecialityDisciplineProgram.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._SpecialityDisciplineProgram.Entity = null;
						previousValue.SpecialityDiscipline = null;
					}
					this._SpecialityDisciplineProgram.Entity = value;
					if ((value != null))
					{
						value.SpecialityDiscipline = this;
					}
					this.SendPropertyChanged("SpecialityDisciplineProgram");
				}
			}
		}
