...
(function (HUB,HTMLCSS,AJAX) {
  HUB.Register.LoadHook(HTMLCSS.fontDir + "/fontdata.js",function () {
    ...
    HTMLCSS.Augment({
      ...
      imgSize: ['050','060','071','085',100,120,141,168,200,238,283,336,400,476,566],
      ...
      handleImg: function (span,font,c,n,text) {
        ...
        var bscale = this.imgBrowserZoom();
        ...
        if (this.imgHeightBug) {
          this.createRule(span,Math.floor((img[1]-img[2])/bscale+.5),
                               Math.floor(img[2]/bscale+.5),0);
        }
        return "";
      },
