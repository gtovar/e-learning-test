...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <p align="left" style="font-size: medium">
        ...
        <input type="submit" id="submitUploadDepartmentStructureFile" name="DepartmentStructure" value="Загрузить"
            style="width: 100px; height: 30px;" />
        <% } %>
    </p>
     <p align="left" style="font-size: medium; margin-top: 10px">
        Загрузка дисциплин:
        ...
        <input type="file" id="uploadSpecialityDisciplineStructureFile" name="uploadSpecialityDisciplineStructureFile"
            style="width: 300px; height: 20px; margin-right: 20px;" />
        <input type="submit" id="SpecialityDisciplineStructure" name="SpecialityDisciplineStructure" value="Загрузить"
            style="width: 100px; height: 30px;" />
        <% } %>
    </p>
     <p align="left" style="font-size: medium; margin-top: 10px">
        ...
        <input type="file" id="uploadSpecialityDisciplineTopicStructureFile" name="uploadSpecialityDisciplineTopicStructureFile"
            style="width: 300px; height: 20px; margin-right: 20px;" />
        <input type="submit" id="SpecialityDisciplineTopicStructure" name="SpecialityDisciplineTopicStructure" value="Загрузить"
            style="width: 100px; height: 30px;" />
        <% } %>
    </p>
     <p align="left" style="font-size: medium; margin-top: 10px">
