...
<%@ Import Namespace="VmkLearningKit" %>
    <table class="Editor" style="width:100%;">
        ...
        <tr class="Editor">
            ...
            <td class="Editor" style="width:85%"><%= Html.Encode("дистрибутивный") %></td>
        </tr>
        <tr class="Editor">
        ...
        <%
            for (int i = 0; i < VLKConstants.MINIMNUM_ANSWERS_NUMBER; i++)
            {
                ...
                <tr class="Editor">
                    ...
                    <td class="Editor"><%= Html.TextArea(VLKConstants.NEW_VARIANT_ANSWER_TEXT + i.ToString(), new { @class = "TextEditor", style = "width:100%; height: 100px;" }) %></td>
                </tr>
                <tr class="Editor">
