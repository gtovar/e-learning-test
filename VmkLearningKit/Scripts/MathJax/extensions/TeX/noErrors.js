...
MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready",function () {
  ...
  //
  // Override root toHTML routine so that error messages
  //   don't have the clipping and other unneeded overhead
  //
  var root_toHTML = MML.root.prototype.toHTML;
  MML.root.Augment({
    toHTML: function (span) {
      if (this.data[0] && this.data[0].data[0] && 
      this.data[0].data[0].isError) {
        return this.data[0].data[0].toHTML(span);
      }
      return root_toHTML.call(this,span);
    }
  });
