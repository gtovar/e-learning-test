...
MathJax.Hub.Insert(
  MathJax.OutputJax['HTML-CSS'].FONTDATA.FONTS['STIXSizeThreeSym'],
  {
    ...
    0x305: [820,-770,0,0,2000],        // ̅
    0x30C: [777,-564,0,0,1460],        // ̌
    0x330: [-117,283,0,-2,1458],       // ̰
    0x332: [-127,177,0,0,2000],        // ̲
    0x338: [662,156,0,137,548],        // ̸
    0x20D0: [749,-584,0,27,1771],      // ⃐
    0x20D1: [749,-584,0,27,1771],      // ⃑
    0x20D6: [735,-482,0,27,1771],      // ⃖
    0x20D7: [735,-482,0,27,1771],      // ⃗
    0x20EC: [-123,288,0,27,1771],      // ⃬
    0x20ED: [-123,288,0,27,1771],      // ⃭
    0x20EE: [-26,279,0,27,1771],       // ⃮
    0x20EF: [-26,279,0,27,1771],       // ⃯
