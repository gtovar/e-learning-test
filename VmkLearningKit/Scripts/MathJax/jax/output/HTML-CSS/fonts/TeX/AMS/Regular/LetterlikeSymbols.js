...
MathJax.Hub.Insert(
  MathJax.OutputJax['HTML-CSS'].FONTDATA.FONTS['MathJax_AMS'],
  {
    ...
    0x2127: [685,22,722,44,675],       // ℧
    0x2132: [695,1,556,55,497],        // Ⅎ
    0x2136: [763,21,667,-22,687],      // ℶ
    0x2137: [764,43,444,-22,422],      // ℷ
    0x2138: [764,43,667,54,640],       // ℸ
    0x2141: [706,23,639,37,577]        // ⅁
  }
);
