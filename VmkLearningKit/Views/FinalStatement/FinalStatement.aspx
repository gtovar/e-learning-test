...
<thead >
        ...
        <tr id="head2" align="center"  style="background-color: Silver; color: Black; font-size:xx-small;">
            <% for (int i = 0; i < topicCount; i++)
               {%>   
			<td id="var_<%=((IEnumerable<SpecialityDisciplineTopic>)ViewData["topics"]).ElementAt(i).Id%>_" style=" width:30px">Вар </td>    
			<td id="ball_<%=((IEnumerable<SpecialityDisciplineTopic>)ViewData["topics"]).ElementAt(i).Id%>_" style=" width:30px">Балл</td>
                <%} %>
        </tr>
 </thead >       
