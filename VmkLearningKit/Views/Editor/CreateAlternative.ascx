...
<%@ Import Namespace="VmkLearningKit" %>
    <table class="Editor" width="100%">
        ...
        <tr class="Editor">
            ...
            <td class="Editor" style="width:80%"><%= Html.Encode("альтернативный") %></td>
        </tr>
        <tr class="Editor">
        ...
        <%
            for (int i = 0; i < VLKConstants.MINIMNUM_ANSWERS_NUMBER; i++)
            {
                ...
                <tr class="Editor">
                    <td class="Editor" style="width:20%"><label for="<%= VLKConstants.NEW_VARIANT_ANSWER_SCORE + i.ToString()%>">Количество баллов:</label></td>
