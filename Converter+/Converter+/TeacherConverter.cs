...
namespace Converter
{
    class TeacherConverter : Converter
    {
                            ...
                            for (int k = 1; k < table.Columns.Count; k++)
                            {
                                ...
                                switch (k)
                                {
                                    ...
                                    case 2:
                                        ...
                                        {
                                            writer.WriteAttributeString("degree", "Отсутствует");
                                        }
                                        break;
                                    case 3:
                                        ...
                                        {
                                            writer.WriteAttributeString("rank", "Отсутствует");
                                        }
                                        break;
                                    case 4:
                                        ...
                                        {
                                            writer.WriteAttributeString("position", "Отсутствует");
                                        }
                                        break;
                                }
                            }
