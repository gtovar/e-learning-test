...
namespace Converter
{
    class SpecialityConverter : Converter
    {
            ...
            for (int i = 1; i <= tables.Count; i++)
            {
                ...
                if (blackSpeciality.IndexOf(i) == -1)
                {
                    for (int j = 1; j < table.Rows.Count; j++)
                    {
                        ...
                        writer.WriteAttributeString("educationPlan", specialityStr[i - 1]);
                        string abbreviation = "";
                        for (int k = 0; k < table.Columns.Count; k++)
                        {
                            ...
                            switch (k)
                            {
                                case 0:
                                    ...
                                    {
                                        writer.WriteAttributeString("code", "Отсутствует");
                                    }
                                    break;
                                case 1:
                                    ...
                                    {
                                        writer.WriteAttributeString("title", "Отсутствует");
                                    }
                                    break;
                                case 2:
                                    ...
                                    {
                                        writer.WriteAttributeString("abbreviation", "Отсутствует");
                                    }
                                    break;
                            }
                        }
